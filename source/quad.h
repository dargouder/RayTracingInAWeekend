...
public:
	...
	Quad() {}
	Quad(Vec3 v00, Vec3 v10, Vec3 v11, Vec3 v01, std::unique_ptr<Material> mat) : m_v00(v00), m_v10(v10), m_v11(v11), m_v01(v01),
	...
	bool hit(const Ray& r, float tmin, float tmax, HitRecord& rec) const {
		...
		// Reject rays using the barycentric coordinates of the interection point with respect to T'
		if((alpha+beta) > 1.0f)
		{
