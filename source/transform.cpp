...
{
	matrix = Matrix4x4(p_matrix[0][0], p_matrix[0][1], p_matrix[0][2], p_matrix[0][3],
...
Transform::Transform(Matrix4x4& p_mat) : matrix(p_mat), matrix_inverse(Matrix4x4::Inverse(p_mat)) {}

Transform::Transform(const Matrix4x4& p_matrix, const Matrix4x4& p_matrix_inverse) : matrix(p_matrix), matrix_inverse(p_matrix_inverse) {}
...
Matrix4x4 Transpose(const Matrix4x4 &p_matrix) {
	return Matrix4x4(p_matrix.matrix[0][0], p_matrix.matrix[1][0], p_matrix.matrix[2][0], p_matrix.matrix[3][0],
		p_matrix.matrix[0][1], p_matrix.matrix[1][1], p_matrix.matrix[2][1], p_matrix.matrix[3][1],
		p_matrix.matrix[0][2], p_matrix.matrix[1][2], p_matrix.matrix[2][2], p_matrix.matrix[3][2],
		p_matrix.matrix[0][3], p_matrix.matrix[1][3], p_matrix.matrix[2][3], p_matrix.matrix[3][3]);
}
...
Vec3 Transform::operator()(const Vec3& p_vector) const {
	...
	float xp = matrix.matrix[0][0] * x + matrix.matrix[0][1] * y + matrix.matrix[0][2] * z + matrix.matrix[0][3];
	float yp = matrix.matrix[1][0] * x + matrix.matrix[1][1] * y + matrix.matrix[1][2] * z + matrix.matrix[1][3];
	float zp = matrix.matrix[2][0] * x + matrix.matrix[2][1] * y + matrix.matrix[2][2] * z + matrix.matrix[2][3];
	float wp = matrix.matrix[3][0] * x + matrix.matrix[3][1] * y + matrix.matrix[3][2] * z + matrix.matrix[3][3];
	if (wp == 1.) {
...
Vec3 Transform::DirectionTransform(const Vec3& p_vector) const {
	...
	float xp = matrix.matrix[0][0] * x + matrix.matrix[0][1] * y + matrix.matrix[0][2] * z;
	float yp = matrix.matrix[1][0] * x + matrix.matrix[1][1] * y + matrix.matrix[1][2] * z;
	float zp = matrix.matrix[2][0] * x + matrix.matrix[2][1] * y + matrix.matrix[2][2] * z;
